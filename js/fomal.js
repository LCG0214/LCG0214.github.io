...
$.ajax({
  ...
  data: {
    key: 'SIYBZ-WBDWT-FNSXA-L4UHC-HJ4RT-FBBB3',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(119.29814, 26.089491, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("2023/11/10 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by LCG %c 你正在访问 Lichg's Blog",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("2023/11/10 00:00:00");
